...
def check_events(
    ai_settings, screen, stats, sb, play_button, ship, aliens, bullets, ship2
):
...
def update_bullets(
    ...
    check_bullet_alien_collisions(
        ai_settings, screen, stats, sb, ship, aliens, bullets, alien_bullets, ship2
    )
...
def create_fleet(ai_settings, screen, ship, aliens, stats):
    ...
    if stats.sublevel == 4:
        ...
        number_rows = (
            3  # get_number_rows(ai_settings, ship.rect.height, alien.rect.height)
        )
